...
struct GrowthRateTest {
    ...
    @Test func selectDefaultGroupOfGrowthRate() async throws {
    ...
    @Test func selectLimitedGroupOfGrowthRate() async throws {
    ...
    @Test func selectPaginatedGroupOfGrowthRate() async throws {
    ...
    @Test func selectSlowByID() async throws {
    ...
    @Test func selectFastByID() async throws {
    ...
    @Test func selectFastThenVerySlowByID() async throws {
    ...
    @Test func selectSlowByName() async throws {
    ...
    @Test func selectFastByName() async throws {
    ...
    @Test func selectFastThenVerySlowByName() async throws {
    ...
    @Test func optionalOnRandomGrowthRate() async throws {
    ...
    @Test func fetchInexistingGrowthRate() async throws {
