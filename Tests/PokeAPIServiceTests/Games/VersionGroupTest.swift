...
struct VersionGroupTest {
    ...
    @Test func selectDefaultGroupOfVersionGroup() async throws {
    ...
    @Test func selectLimitedGroupOfVersionGroup() async throws {
    ...
    @Test func selectPaginatedGroupOfVersionGroup() async throws {
    ...
    @Test func selectRedBlueByID() async throws {
    ...
    @Test func selectGoldSilverByID() async throws {
    ...
    @Test func selectBlackWhiteByID() async throws {
    ...
    @Test func selectSunMoonByID() async throws {
    ...
    @Test func selectSwordShieldByID() async throws {
    ...
    @Test func selectScarletVioletByID() async throws {
    ...
    @Test func selectRedBlueByName() async throws {
    ...
    @Test func selectGoldSilverByName() async throws {
    ...
    @Test func selectBlackWhiteByName() async throws {
    ...
    @Test func selectSunMoonByName() async throws {
    ...
    @Test func selectSwordShieldByName() async throws {
    ...
    @Test func selectScarletVioletByName() async throws {
    ...
    @Test func optionalOnRandomVersionGroup() async throws {
    ...
    @Test func selectInexistingVersionGroup() async throws {
